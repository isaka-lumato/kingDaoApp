# AGENTS.md — KDL Import Consignment Tracker

This file is the **operating manual** for any Codex session working on this project. Read it before touching anything else.
